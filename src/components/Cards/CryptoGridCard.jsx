...
import { faArrowTrendDown, faArrowTrendUp, faCartShopping, faStar } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <motion.div 
      ...
      <div className='border-2  bg-gray-900 text-white rounded-lg p-4 shadow-lg'>
       ...
       <div className='name-div mb-8 flex justify-between'>
        ...
        <img src={image}/>
        <h2 className="text-2xl font-semibold ml-2">{name.length>6 ? symbol.toUpperCase() : name}</h2>
        </div>


        <div className='trend-div flex gap-4 '>
        <div className={`flex Price-trend border-2 rounded-full px-2 items-center ${isGreen? 'border-green-600' : 'border-red-600'}`}>
        {
              isGreen ?
    ...
    {price_change_percentage_24h.toFixed(2)}%
       ...
       <div className='price-cap-div flex justify-between mb-6'>
        <div > <span className="text-xl font-bold">₹ {current_price}</span></div>
        <div>
        <p className='text-lg'>Cap: {(market_cap/1000000000).toFixed()} B</p>
        </div>
       </div>
       ...
       <div className='ath flex justify-between mb-4'>
        ...
        <span
              className=
                ...
                "text-red-500 font-bold border-red-500 border-2 rounded-xl px-1 py-1 cursor-pointer"
       ...
       <div className='atl flex justify-between mb-6'>
        ...
        <span
              className=
                ...
                "text-green-500 font-bold border-green-500 border-2 rounded-xl px-1 py-1 cursor-pointer"
    ...
    {atl_change_percentage.toFixed(2)}% Up From ATL
       ...
       <div className='footer-div flex justify-evenly border-t-2'>
        ...
        <FontAwesomeIcon icon={faCartShopping} size="xl" style={{color: "#63E6BE",}} />
